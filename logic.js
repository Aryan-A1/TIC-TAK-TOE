...
function reinitiate() {
  document
    .getElementsByClassName("block1")[0]
    .classList.toggle(classFilled[0][0]);
  document
    .getElementsByClassName("block2")[0]
    .classList.toggle(classFilled[0][1]);
  document
    .getElementsByClassName("block3")[0]
    .classList.toggle(classFilled[0][2]);
  document
    .getElementsByClassName("block4")[0]
    .classList.toggle(classFilled[1][0]);
  document
    .getElementsByClassName("block5")[0]
    .classList.toggle(classFilled[1][1]);
  document
    .getElementsByClassName("block6")[0]
    .classList.toggle(classFilled[1][2]);
  document
    .getElementsByClassName("block7")[0]
    .classList.toggle(classFilled[2][0]);
  document
    .getElementsByClassName("block8")[0]
    .classList.toggle(classFilled[2][1]);
  document
    .getElementsByClassName("block9")[0]
    .classList.toggle(classFilled[2][2]);
  board = [
    [-1, -1, -1],
    [-1, -1, -1],
    [-1, -1, -1],
